...
def Config():
    ...
    # scale sampling  
    conf.test_scale = (512, 1792)
    conf.crop_size = [512, 1792]
    ...
    conf.anchor_ratios = np.array([0.5, 1.0, 1.25, 1.5])
    ...
    # conf.pretrained = 'output/kitti_3d_multi_warmup_org/weights/model_50000_pkl'

    conf.flow = False
    
    # video
    conf.video_det = False
    conf.video_count = 2
    return conf
