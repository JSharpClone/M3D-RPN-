...
kitti_val['flow'] = os.path.join(base_data, split, 'validation', 'flow_feature')
...
for line in text_file:
    ...
    if parsed is not None:
        ...
        if not os.path.exists(os.path.join(kitti_tra['right'], str(new_id) + '.png')):
            os.symlink(os.path.join(kitti_raw['right'], str(id) + '.png'), os.path.join(kitti_tra['right'], str(new_id) + '.png'))
        ...
        if not os.path.exists(os.path.join(kitti_tra['flow'], str(new_id) + '.npy')):
            os.symlink(os.path.join(kitti_raw['flow'], str(id) + '.npy'), os.path.join(kitti_tra['flow'], str(new_id) + '.npy'))
...
for line in text_file:
    ...
    if parsed is not None:
        ...
        if not os.path.exists(os.path.join(kitti_val['right'], str(new_id) + '.png')):
            os.symlink(os.path.join(kitti_raw['right'], str(id) + '.png'), os.path.join(kitti_val['right'], str(new_id) + '.png'))
        ...
        if not os.path.exists(os.path.join(kitti_val['flow'], str(new_id) + '.npy')):
            os.symlink(os.path.join(kitti_raw['flow'], str(id) + '.npy'), os.path.join(kitti_val['flow'], str(new_id) + '.npy'))
